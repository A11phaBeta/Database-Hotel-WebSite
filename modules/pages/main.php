    ...
    <article class="container-fluid">
        ...
        <div class="container-fluid intro-hotel bg-white" id="intro-hotel">
            ...
            <div class="intro-content">
                ...
                <p>DCS Hotel를 찾아주신 수많은 국빈분들은 '경복궁 야경'을 잊지 못한다고 하셨습니다. 경복궁 바로 앞에 위치하여 아름다운 야경 뷰를 관람하실 수 있습니다.</p>
            </div>

            <div class="intro-content">
                <h4>최고의 호텔</h4>
                <p>DCS Hotel은 '최고의 호스피탈리티 기업'을 목표로 오랜 세월동안 품위와 전통을 유지하며 고객들의 마음을 사로잡아 왔습니다.</br>세계 최고의 럭셔리 호텔들과 어깨를 나란히 하는가 하면 전통이라는 지붕 위에 모더니즘적 디자인 요소를 가미, 삶의 여유와 품격을 한층 높여주는 </br>프리미엄 라이프 스타일 공간으로 변화를 거듭해 왔습니다.</p>
            </div>
