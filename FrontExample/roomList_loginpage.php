...
<body>
  ...
  <main>
    ...
    <div class="login-form">
      <form name="login_from" method="post" action="../api/modules/login2.php">
        ...
        <input type="button" value="로그인" class="submit-btn" onclick="LOGIN()">
      </form>

      <div class="links">
        <a href="lostpassword.php">비밀번호를 잊어버리셨나요?</a>
        <a href="signUp.php" class="sign_up">회원가입</a>
      </div>
    </div>
  </main>
