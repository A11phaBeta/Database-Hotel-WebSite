  ...
  <main>
    ...
    <div class="container_mypage1">
      ...
      <div class="mypage_main">
        ...
        <div class="mypage_reservation_title">
          객실 예약 내역
        </div>
        <div class="mypage_reservation_content">
        ...
        <table class = "mypage_reservation_table">
          <tr>
            <th>예약번호</th>
            <th>객실</th>
            <th>객실수</th>
        ...
        $R_Number=$_GET['rownumber'];
          ...
          for($i=0;$i<$R_Number;$i++){
            ...
            <td>예약</td>
            <td><input type="button" name="취소하기" value="취소하기"></td>
          </tr>
          <tr>
            <td>54321</td>
            <td>디럭스룸</td>
