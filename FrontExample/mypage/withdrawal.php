  ...
  <main>
    <div class="container_mypage1">
      ...
      <div class="mypage_main">
        ...
        <div class="mypage_withdrawal_title">
          탈퇴하시려는 사유를 입력해주세요.
        </div>
        <textarea name="name" class="request" rows="8" cols="80" placeholder="저희 호텔에 하고싶으신 말씀을 적어주세요."></textarea>
        <div class="mypage_withdrawal_agreement2">
          <a class = "agreement_subtitle">회원탈퇴 안내사항</a>
          <ol class="sublist">
            <li>탈퇴 이후에는 보유하신 쿠폰, 마일리지 그리고 참여하신 이벤트의 응모 및 당첨 혜택이 모두 소멸됩니다.</li>
            <li>회원정보는 탈퇴 시 관련법령에 따라 보관 의무가 있는 경우를 제외하고는 즉시 삭제됩니다.</li>
            <li>전자상거래 등에서의 소비자보호에 관한 법률에 따라 계약 또는 청약철회에 관한 기록,<br>
              대금 결제 및 재화 등의 공급에 관한 기록은 5년, 그리고 소비자의 불만 또는 분쟁처리에 관한 기록은 3년간 보존됩니다.</li>
            <li>탈퇴 이후에는 어떠한 방법으로도 삭제된 회원정보를 복원할 수 없습니다.</li>
          </ol>
        </div>
