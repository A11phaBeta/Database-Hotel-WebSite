    ...
    <div class="container_mypage1">
      <div class="mypage_content">
        ...
        <div class="mypage_main">
          <div class="mypage_main_pwdtitle">
            비밀번호 확인
          </div>
          <form name="password_check" method="post" action="../../api/modules/pw_check.php">
          <div class="mypage_main_pwdbutton1">
            <input type="password" name="password" class="text-field" placeholder="password">
          </div>
          </form>
          <div class="mypage_main_pwdbutton2">
            <input type="button" value="확인" class="submit-btn" onclick="Click()">
          </div>
          <div class="links1">
            <a href="../lostpassword.php">비밀번호를 잊어버리셨나요?</a>
          </div>
      </div>
