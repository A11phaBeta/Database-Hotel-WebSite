...
function isEmailCorrect() {
    ...
    if(email.value === ""){
      ...
      error[0].innerHTML = "이메일형식으로 다시 입력해주세요.";
      error[0].style.display = "block";
    } else {
...
function checkPw() {
    ...
    if(pw1.value === "") {
        ...
        pwImg1.src = "/Users/iseungseob/Desktop/Database-Hotel-WebSite/Front Example/img/m_icon_not_use.png";
    } else {
        error[1].style.display = "none";
        pwMsg.innerHTML = "안전";
        pwMsg.style.display = "block";
        pwMsg.style.color = "#03c75a";
        pwImg1.src = "/Users/iseungseob/Desktop/Database-Hotel-WebSite/Front Example/img/m_icon_safe.png";
    }
}

function comparePw() {
    if(pw2.value === pw1.value && pw2.value != "") {
        pwImg2.src = "/Users/iseungseob/Desktop/Database-Hotel-WebSite/Front Example/img/m_icon_check_enable.png";
        error[2].style.display = "none";
    } else if(pw2.value !== pw1.value) {
        pwImg2.src = "/Users/iseungseob/Desktop/Database-Hotel-WebSite/Front Example/img/m_icon_check_disable.png";
